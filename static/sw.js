...
const CACHE = 'veninfo-v54';
const SHELL = ['/', '/calculadora', '/assets/style.css', '/icon.svg', '/icon-192.png', '/icon-calc.svg', '/icon-calc-192.png', '/icon-calc-512.png', '/manifest-calc.webmanifest'];
