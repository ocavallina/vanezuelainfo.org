...
const CACHE = 'veninfo-v61';
const SHELL = ['/', '/calculadora', '/assets/style.css?v=61', '/icon.svg', '/icon-192.png', '/icon-calc.svg', '/icon-calc-192.png', '/icon-calc-512.png', '/manifest-calc.webmanifest'];
