...
const CACHE = 'veninfo-v63';
const SHELL = ['/', '/calculadora', '/assets/style.css?v=63', '/icon.svg', '/icon-192.png', '/icon-calc.svg', '/icon-calc-192.png', '/icon-calc-512.png', '/manifest-calc.webmanifest'];
